...
window.JMHZ_VIEWER_TEMPLATE = `<!-- Toolbar -->
  <div class="toolbar">
    <div class="toolbar-left">
      <img :src="assetBase + 'abra-logo-2026.svg'" alt="ABRA" style="flex-shrink: 0; height: 28px; width: auto;">
    ...
    <div class="view-picker-box">
      ...
      <div class="view-picker-options">
        <div class="view-picker-card" @click="pickViewMode('table')">
          <div class="view-picker-preview"><img :src="assetBase + 'preview-table.png'" alt="Tabulka"></div>
          <h3>Tabulka</h3>
        ...
        <div class="view-picker-card" @click="pickViewMode('cards')">
          <div class="view-picker-preview"><img :src="assetBase + 'preview-cards.png'" alt="Karty"></div>
          <h3>Karty</h3>
